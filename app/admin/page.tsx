...
export default function AdminPage() {
  ...
  return <main className="admin-page"><Link href="/">← Back to site</Link><h1>Content admin</h1><p>This area only shows community notes and product feedback that people actively submitted. It never receives local screenshot OCR, self-check answers or private chat analysis.</p>
